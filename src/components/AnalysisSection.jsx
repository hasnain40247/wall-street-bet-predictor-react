...
const handleClick=()=>{
    ...
    setDisabled(1)
        ...
        fetch("/members").then(
            ...
            data=>{
                setData(data)
                console.log( JSON.parse( String(data["plot_json"]['Bearish'])));
...
<PlotComponent link={"http://localhost:5000/static/freq.png"} title={"Frequency Of Stock Mentions"}/>
<PlotComponent link={"http://localhost:5000/static/picks.png"} title={"Top 10 Stock Picks"}/>
<PlotComponent link={"http://localhost:5000/static/sentiment.png"} title={"Sentiment Analysis"}/>
